        ...
        while True:
            ...
            if TARGET_BOT_ID not in active_poses:
                ...
                if lost_frames > MAX_LOST_FRAMES or last_pose is None:
                    ...
                    # Single frame dropout — just reuse last known pose, don't dead reckon yet
            ...
            while not homing_complete:
                ...
                # First waypoint is the home target
                home_x, home_y, home_theta = trajectory[0]
            ...
            if current_waypoint_idx < len(trajectory):
                ...
                print(f"Bot: ({robot_x:.2f}, {robot_y:.2f}, {robot_theta:.2f}) | Target: ({target_x:.2f}, {target_y:.2f}) | L: {left_mps:.2f} R: {right_mps:.2f}")
                if arrived:
