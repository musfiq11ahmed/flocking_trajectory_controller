...
# ==========================================
# We will generate a parametric S-curve that natively fits your arena
num_points = 250
...
# ==========================================
# 3. EXPORT DIRECTLY TO HARDWARE-READY CSV
# ==========================================
df = pd.DataFrame({
    'x': x,
    'y': y,
...
# Save it to the exact same file your viewer and swarm controller use
