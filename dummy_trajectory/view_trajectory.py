...
# ==========================================
# Plotting an arrow for every single 50Hz data point would look like a giant red blob.
# We will step through the data and draw an arrow every 25 frames (every 0.5 seconds).
step = 25 
...
# ADD THESE LINES: Lock the plot directly to your exact physical arena dimensions
